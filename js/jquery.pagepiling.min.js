...
(function(b) {
	b.fn.pagepiling = function(c) {
		...
		function E(a) {
			...
			a.preventDefault();
			z(a.target) || ( a = b(".pp-section.active"),
			a = w(a), l() || ( d = y(d),
			touchEndY = d.y,
			touchEndX = d.x, Math.abs(touchStartY - touchEndY) > e.height() / 100 * c.touchSensitivity && (touchStartY > touchEndY ? k("down", a) : touchEndY > touchStartY && k("up", a))))
		}
		...
		function G() {
			...
			b = window.getComputedStyle(a).getPropertyValue(c[e]));
